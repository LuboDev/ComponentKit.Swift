...
let package = Package(
        ...
        dependencies: [
            ...
            .package(url: "https://github.com/LuboDev/HUD.Swift.git", .upToNextMajor(from: "1.0.0")),
            .package(url: "https://github.com/LuboDev/LanguageKit.Swift.git", .upToNextMajor(from: "1.0.0")),
            .package(url: "https://github.com/LuboDev/SectionsTableView.Swift.git", .upToNextMajor(from: "1.0.0")),
            .package(url: "https://github.com/LuboDev/ThemeKit.Swift", .upToNextMajor(from: "1.0.0")),
